...
def resim_core_dependencies():
    ...
    maybe(
        http_archive,
        name = "lz4",
        build_file = "//resim/third_party/lz4:lz4.BUILD",
    ...
    maybe(
        http_archive,
        name = "zstd",
        build_file = "//resim/third_party/zstd:zstd.BUILD",
    ...
    maybe(
        http_archive,
        name = "mcap",
        build_file = "//resim/third_party/mcap:mcap.BUILD",
    ...
    maybe(
        ...
        build_file = "//resim/third_party/foxglove_schemas:schemas.BUILD",
    ...
    maybe(
        http_archive,
        name = "pmp",
        build_file = "//resim/third_party/pmp:pmp.BUILD",
    ...
    maybe(
        http_archive,
        name = "libccd",
        build_file = "//resim/third_party/libccd:libccd.BUILD",
        patch_args = ["-p1"],
        # Patch to generate files ordinarily generated by cmake:
        patches = ["//resim/third_party/libccd:libccd.patch"],
    ...
    maybe(
        http_archive,
        name = "fcl",
        build_file = "//resim/third_party/fcl:fcl.BUILD",
        patch_args = ["-p1"],
        # Patch to generate files ordinarily generated by cmake:
        patches = ["//resim/third_party/fcl:fcl.patch"],
    ...
    maybe(
        http_archive,
        name = "flamegraph",
        build_file = "//resim/third_party/flamegraph:flamegraph.BUILD",
    ...
    maybe(
        http_archive,
        name = "indicators",
        build_file = "//resim/third_party/indicators:indicators.BUILD",
    ...
    maybe(
        ...
        build_file = "//resim/third_party/nlohmann_json:nlohmann_json.BUILD",
