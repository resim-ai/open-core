...
> NOTE: If you're wanting to develop locally, you can retrieve your authToken from [https://app.signalflag.ai/debug](https://app.signalflag.ai/debug) in the `auth.bearer` field.
