...
class PolygonDistanceTest(unittest.TestCase):
    ...
    def test_polygon_distance(self) -> None:
        poly_a = [np.array([-1.0, -0.5]), np.array([1.0, -0.5]), np.array([0.0, 1.0])]
        poly_b = [np.array([-1.0, 0.5]), np.array([1.0, 0.5]), np.array([0.0, -1.0])]
        poly_c = [
            np.array([-1.0, 1.5]),
            np.array([1.0, 1.5]),
            np.array([1.0, 2.5]),
        ...
        self.assertEqual(polydist.polygon_distance(poly_a, poly_b), 0.0)
