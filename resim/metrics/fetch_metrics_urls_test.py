...
@patch("signalflag.sdk.client.AuthenticatedClient")
class FetchMetricsUrlsTest(unittest.TestCase):
    """The unit test case itself."""

    def test_fetch_metrics_urls(
        self, authenticated_client_mock: unittest.mock.MagicMock
    ) -> None:
        """
