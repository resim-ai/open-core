...
def _intersection(
    ...
    intersection_max_x: float = min(box_a.center_x + 0.5 * box_a.size_x,
                                    box_b.center_x + 0.5 * box_b.size_x)
    intersection_min_x: float = max(box_a.center_x - 0.5 * box_a.size_x,
                                    box_b.center_x - 0.5 * box_b.size_x)
    intersection_max_y: float = min(box_a.center_y + 0.5 * box_a.size_y,
                                    box_b.center_y + 0.5 * box_b.size_y)
    intersection_min_y: float = max(box_a.center_y - 0.5 * box_a.size_y,
                                    box_b.center_y - 0.5 * box_b.size_y)
