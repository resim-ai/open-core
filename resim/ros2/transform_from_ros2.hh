...
msg::TransformStamped convert_from_ros2(
    const geometry_msgs::msg::TransformStamped &ros2_msg);

geometry_msgs::msg::TransformStamped convert_to_ros2(
    const msg::TransformStamped &resim_msg);

msg::TransformArray convert_from_ros2(const tf2_msgs::msg::TFMessage &ros2_msg);

tf2_msgs::msg::TFMessage convert_to_ros2(const msg::TransformArray &resim_msg);
