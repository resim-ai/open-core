...
client = UsernamePasswordClient(
    username="your_username", # or set the `SIGNALFLAG_USERNAME` environment variable (legacy `RESIM_USERNAME` also works)
    password="your_password"  # or set the `SIGNALFLAG_PASSWORD` environment variable (legacy `RESIM_PASSWORD` also works)
)
```
...
```python
from signalflag.sdk.client.models import Batch, ListBatchesOutput
from signalflag.sdk.client.api.batches import list_batches
from signalflag.sdk.client.types import Response
...
```python
from signalflag.sdk.client.models import Batch
from signalflag.sdk.client.api.batches import list_batches
from signalflag.sdk.client.types import Response
...
1. Any endpoint which did not have a tag is in `signalflag.sdk.client.api.default`

### Example: updating an experience

If you are looking to update an experience, browse to the [updateExperience endpoint](https://redocly.github.io/redoc/?url=https://api.resim.ai#tag/experiences/operation/updateExperience) and you'll see that it has a tag of `experiences`. This means that the generated module will be `signalflag.sdk.client.api.experiences.update_experience`. A quick usage example:

```python
from signalflag.sdk.client.models import UpdateExperienceInput, Experience
from signalflag.sdk.client.api.experiences import update_experience
...
```python
from signalflag.sdk.client import Client
