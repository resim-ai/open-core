...
class BatchTest(unittest.TestCase):
    ...
    @patch("signalflag.sdk.batch.metrics")
    @patch("signalflag.sdk.batch.close_batch")
    @patch("signalflag.sdk.batch.create_light_batch")
    @patch("signalflag.sdk.batch.list_branches_for_project")
    def test_batch(
        self,
        mock_list_branches: Any,
        mock_create_batch: Any,
    ...
    @patch("signalflag.sdk.batch.create_light_batch")
    @patch("signalflag.sdk.batch.list_branches_for_project")
    @patch("signalflag.sdk.batch.list_projects")
    ...
    @patch("signalflag.sdk.batch.close_batch")
    @patch("signalflag.sdk.batch.create_light_batch")
    @patch("signalflag.sdk.batch.list_systems")
    @patch("signalflag.sdk.batch.list_branches_for_project")
    ...
    @patch("signalflag.sdk.batch.close_batch")
    @patch("signalflag.sdk.batch.create_light_batch")
    @patch("signalflag.sdk.batch.list_test_suites")
    @patch("signalflag.sdk.batch.list_branches_for_project")
