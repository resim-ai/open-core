...
from signalflag.sdk.test import Test, LogType, LogUploadError, UPLOAD_TIMEOUT_S
...
class TestTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_create_job = self._patch("signalflag.sdk.test.create_job_for_batch")
        self.mock_create_log = self._patch("signalflag.sdk.test.create_job_log")
        self.mock_close_job = self._patch("signalflag.sdk.test.close_job")
        self.mock_httpx = self._patch("signalflag.sdk.test.httpx")
        # Retry backoff would otherwise add seconds to the suite.
        self.mock_sleep = self._patch("signalflag.sdk.test.time.sleep")
    ...
    @patch("signalflag.sdk.test.os.unlink")
    @patch("signalflag.sdk.test.tempfile.NamedTemporaryFile")
